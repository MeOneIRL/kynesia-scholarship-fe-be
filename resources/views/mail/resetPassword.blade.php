    ...
    <section class="container mx-2.5 md:mx-24">
        <div class="content max-w-screen-sm mx-auto flex flex-col gap-4">
            ...
            <div class="gap text-secondary-color">
                <p>Untuk melakukan reset password akun kamu,</p>
                <p>Silahkan menekan tombol dibawah ini</p>
            </div>
            <div class="btn gap">
                <a href="{{route('passwordForm',$token)}}">
                    <button type="button"
            ...
            <div class="gap">
                ...
                <a class="text-blue-500 underline"
                    href="{{route('passwordForm',$token)}}">{{route('passwordForm',$token)}}</a>
            </div>
            <div class="gap text-secondary-color">
                <p>
                    Email ini hanya untuk tujuan melakukan reset password, jika anda memiliki pertanyaan silahkan menuju
                    <span>
