    ...
    <div class="md:mx-24 md:flex" x-data="handler()">
        ...
        <div class="md:w-3/4">
            ...
            <div class="px-5 md:px-12 py-12">
                ...
                <form action="{{route('stepOneAdminAccept',$user->id)}}" method="POST">
                    @csrf
                    <div class="overflow-hidden">
                        <div class="px-4 py-5 bg-white sm:p-0">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6">
                                    <h3 class="text-primary-color text-lg font-bold ">Penerimaan Tahap 1</h3>
                                </div>
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6">
                                            <label for="father_name"
                                                class="block text-sm font-medium text-secondary-color">Link Interview</label>
                                            <input type="text" name="onlineInterview" id="father_name"
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="father_birthdate"
                                                class="block text-sm font-medium text-secondary-color">Tanggal Interview</label>
                                            <input type="date" name="interviewDate" id="father_birthdate"
                                                class="mt-1 focus:ring-primary-color focus:border-primary-color block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                                >
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="father_birthdate"
                                                class="block text-sm font-medium text-secondary-color">Waktu Interview</label>
                                            <input type="time" name="interviewTime" id="father_birthdate"
                                                class="mt-1 focus:ring-primary-color focus:border-primary-color block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                                >
