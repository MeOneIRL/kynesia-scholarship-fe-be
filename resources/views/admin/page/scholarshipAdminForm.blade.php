    ...
    <div class="md:mx-24 md:flex" x-data="handler()">
        ...
        <div class="md:w-3/4">
            ...
            <div class="px-5 md:px-12 py-12">
                ...
                <form action="{{route('scholarshipAdminPost')}}" method="POST">
                    @csrf
                    <div class="overflow-hidden">
                        <div class="px-4 py-5 bg-white sm:p-0">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6">
                                    <h3 class="text-primary-color text-lg font-bold ">Form Pembuatan Beasiswa</h3>
                                </div>

                                <div class="col-span-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6">
                                            <p class="text-secondary-color font-bold">Beasiswa</p>
                                        </div>
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="father_name"
                                                class="block text-sm font-medium text-secondary-color">Nama
                                                Beasiswa</label>
                                            <input type="text" name="name" id="father_name"
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="father_name"
                                                class="block text-sm font-medium text-secondary-color">Link Online Test</label>
                                            <input type="text" name="onlineTest" id="father_name"
                                                class="mt-1 focus:ring-primary-color focus:border-primary-color block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                                >
                                            <div class="error">@error('onlineTest'){{$message}}@enderror</div>
                                        </div>
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="father_birthdate"
                                                class="block text-sm font-medium text-secondary-color">Mulai Tahap 1</label>
                                            <input type="date" name="startStepOne" id="father_birthdate"
                                                class="mt-1 focus:ring-primary-color focus:border-primary-color block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                                >
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="father_birthdate"
                                                class="block text-sm font-medium text-secondary-color">Akhir Tahap 1</label>
                                            <input type="date" name="endStepOne" id="father_birthdate"
                                                class="mt-1 focus:ring-primary-color focus:border-primary-color block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                                >
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="father_birthdate"
                                                class="block text-sm font-medium text-secondary-color">Mulai Tahap 2</label>
                                            <input type="date" name="startStepTwo" id="father_birthdate"
                                                class="mt-1 focus:ring-primary-color focus:border-primary-color block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                                >
                                            <div class="error">@error('startStepTwo'){{$message}}@enderror</div>
                                        </div>
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="father_birthdate"
                                                class="block text-sm font-medium text-secondary-color">Akhir Tahap 2</label>
                                            <input type="date" name="endStepTwo" id="father_birthdate"
                                                class="mt-1 focus:ring-primary-color focus:border-primary-color block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                                >
                                            <div class="error">@error('endStepTwo'){{$message}}@enderror</div>
                                        </div>
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="father_birthdate"
                                                class="block text-sm font-medium text-secondary-color">Pengumuman Tahap 1</label>
                                            <input type="date" name="announceStepOne" id="father_birthdate"
                                                class="mt-1 focus:ring-primary-color focus:border-primary-color block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                                >
                                            <div class="error">@error('announceStepOne'){{$message}}@enderror</div>
                                        </div>
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="father_birthdate"
                                                class="block text-sm font-medium text-secondary-color">Pengumuman Tahap 2</label>
                                            <input type="date" name="announceStepTwo" id="father_birthdate"
                                                class="mt-1 focus:ring-primary-color focus:border-primary-color block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                                >
                                            <div class="error">@error('announceStepTwo'){{$message}}@enderror</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
